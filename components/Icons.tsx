...
export const FingerPrintIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.864 4.243A7.5 7.5 0 0 1 19.5 10.5c0 2.92-.556 5.709-1.587 8.188a11.253 11.253 0 0 1-5.413 5.413m-3.586-5.413a3.375 3.375 0 0 0-3.375-3.375m3.375 3.375a3.375 3.375 0 0 1-3.375 3.375m3.375-3.375C9.176 16.5 7.5 14.828 7.5 12.75c0-1.76.79-3.34 2.003-4.398m7.133-4.398A7.5 7.5 0 0 0 12 3.75a7.5 7.5 0 0 0-4.364 1.243m11.527 4.398A3.375 3.375 0 0 1 16.5 12c0 1.63-.673 3.09-1.757 4.125m1.757-4.125a3.375 3.375 0 0 0-3.375-3.375m3.375 3.375a3.375 3.375 0 0 1-3.375 3.375M12 12.75h.008v.008H12v-.008Z" />
    </svg>
);
...
export const SwatchIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 0 0-5.78 1.128 2.25 2.25 0 0 1-2.475 2.118A2.25 2.25 0 0 0 1.5 21H21a2.25 2.25 0 0 0 2.25-2.25v-8.38a2.25 2.25 0 0 0-1.884-2.22l-1.523-.29a1.125 1.125 0 0 0-1.077.228 12.06 12.06 0 0 1-5.467 4.133Z" />
    </svg>
);
